...
void rebuild(char *filename)
{
    ...
    // memset(m_item_count, 0, sizeof(m_item_count));
    // memset(g_item_count, 0, sizeof(g_item_count));
    // memset(g_adj_count, 0, sizeof(g_adj_count));
    // memset(n_ele_count, 0, sizeof(n_ele_count));
    edgenum = 0;
    ...
    best_uncovered_weight = total_weight+1;
